...
> whole stack runs locally with one command.
...
**Switching to the second terminal** showing `pulse logs -f ingest-worker`.
...
**Input the structured-DSL query:**
...
**Switch to browser** http://localhost:8000/docs &mdash; the
...
>
> Everything's at github.com/AaronHuang-git/pulse-agentic-lakehouse-backend-build.
